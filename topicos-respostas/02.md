...
Em resumo, o que supostamente se ganha com código em C++ em relação ao código em C é a representação da abstração OO mais facilmente representada no código.
