...
<br>**RESPOSTA:**<br>
A <ins>abstração OO</ins>, que existe na nossa cabeça do ser humano, representa uma forma melhor de ver a solução do problema. Contudo, o ser humano precisa <ins>representar em código a abstração OO</ins>. **C++ torna mais fácil representar em código a abstração OO do que C**.<br>
