...
A abstração OO existe na nossa cabeça do ser humano é mais naturalmente expressa em código ao usar C++ (em vez de C).<br>
Vale ressaltar que um código em C++ pode resultar em maior tempo de execução do que um código equivalente em C. Isso ocorre pois algumas implementações OO são mais custosas para processamento (por exemplo, a implementa;áo do polimorfismo).<br>
